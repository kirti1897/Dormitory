<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="hostin.aspx.cs" Inherits="DormFinal1.hostin" %>
        ...
        <div class="hotel-left-w3ls">
            <div class="main">
                  <div class="form-left-to-w3l"> 
                    ...
                    <asp:Button ID="btnStudent" runat="server" Text="Student" Width="120px"
                            CssClass="btnForm" Height="58px" onclick="btnStudent_Click"></asp:Button>
                        <asp:Button ID="bnWar"
                            runat="server" Text="Rector" Width="120px"
                            CssClass="btnForm" Height="58px" onclick="bnWar_Click" /></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /><br /><br />
                    <asp:Button ID="btnAdmin" runat="server" Text="Admin" Width="120px"
                            CssClass="btnForm" Height="58px" onclick="btnAdmin_Click"></asp:Button><asp:Button ID="btnLBack" 
                            runat="server" Text="Back" Width="120px"
                            CssClass="btnForm" Height="58px"></asp:Button>
                   </div>
            </div>
        </div>
        </form>
